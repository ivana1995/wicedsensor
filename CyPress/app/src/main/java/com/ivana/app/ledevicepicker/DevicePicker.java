 ...
 *
 ******************************************************************************/
package com.ivana.app.ledevicepicker;
...
import static com.ivana.app.wicedsense.BuildConfig.APPLICATION_ID;
...
public class DevicePicker {
     ...
     */
    public static final String ACTION_LAUNCH = "com.ivana.app.ledevicepicker.action.LAUNCH";
    /**
     ...
     * screen
     */
    public static final String ACTION_DEVICE_SELECTED = APPLICATION_ID + ".ledevicepicker.action.DEVICE_SELECTED";

    public static final String ACTION_CANCELLED = APPLICATION_ID + "..ledevicepicker.action.CANCELED";
    /**
