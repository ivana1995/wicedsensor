...
import com.ivana.app.wicedsense.AnimationManager.Animated;
...
// This class is used to render accelerometer data
public class Accelerometer2Fragment extends Fragment implements OnClickListener, Animated {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.accelerometer2_fragment, null);
        return v;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mNeedle = (ImageView) view.findViewById(R.id.iv_black_line);
    ...
    public void setValue(AnimationManager animation, float x, float y, float z)
        ...
        mY = y;
        mZ = z;
        mAngle = (float) (Math.atan2(y, x) * 180.0 / Math.PI);
...
// Display the values of x,y,z and the angle on the screen
